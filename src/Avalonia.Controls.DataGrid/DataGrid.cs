...
internal
    ...
    partial class DataGrid : TemplatedControl
    {
        ...
        static DataGrid()
        {
            ...
            CellStyleProperty.Changed.AddClassHandler<DataGrid>((x, e) => x.OnCellStyleChanged(e));
            ...
            EnableColumnFiltersProperty.Changed.AddClassHandler<DataGrid>((x, e) => x.OnEnableColumnFiltersChanged(e));
        ...
        public DataGrid()
        {
            ...
            ContextRequested += OnContextRequestedInternal;
        ...
        private void OnEnableColumnFiltersChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            {
                if (column != null && column.HasHeaderCell)
                {
                    column.HeaderCell.RefreshFilterButtonVisibility();
                }
            }
        }
        ...
        private (DataGridCell Cell, DataGridColumn Column, object Item) HitTestCell(Point point)
        {
            var visual = this.GetVisualAt(point);
            var cell = visual?.GetSelfAndVisualAncestors().OfType<DataGridCell>().FirstOrDefault();
            return (cell, cell?.OwningColumn, cell?.DataContext);
        }
