...
internal static partial class DataGridDiagnostics
{
    ...
    private static Histogram<double>? s_hierarchicalRefresh;
    private static Histogram<double>? s_hierarchicalFlattenedApply;
    private static Histogram<double>? s_cellPseudoClassUpdate;
    ...
    private static Counter<long>? s_hierarchicalFlattenedApplyGateCount;
    ...
    public static void InitMetrics()
    {
        ...
        s_hierarchicalRefresh = meter.CreateHistogram<double>(
            Meters.HierarchicalRefreshTimeName,
            Meters.MillisecondsUnit,
            Meters.HierarchicalRefreshTimeDescription);
        s_hierarchicalFlattenedApply = meter.CreateHistogram<double>(
            Meters.HierarchicalFlattenedApplyTimeName,
            Meters.MillisecondsUnit,
            Meters.HierarchicalFlattenedApplyTimeDescription);
        s_cellPseudoClassUpdate = meter.CreateHistogram<double>(
            Meters.CellPseudoClassUpdateTimeName,
            Meters.MillisecondsUnit,
            Meters.CellPseudoClassUpdateTimeDescription);
        ...
        s_hierarchicalFlattenedApplyGateCount = meter.CreateCounter<long>(
            Meters.HierarchicalFlattenedApplyGateCountName,
            Meters.DecisionsUnit,
            Meters.HierarchicalFlattenedApplyGateCountDescription);
    }
    ...
    public static HistogramReportDisposable BeginHierarchicalFlattenedApply() => Begin(s_hierarchicalFlattenedApply);
    public static HistogramReportDisposable BeginCellPseudoClassUpdate() => Begin(s_cellPseudoClassUpdate);

    public static void RecordHierarchicalRefreshDuration(double elapsedMs)
    {
        ...
        s_hierarchicalRefresh?.Record(elapsedMs);
    }
    ...
    public static void RecordHierarchicalFlattenedApplyGate(bool canApply, string reason, int changeCount)
    {
        var counter = s_hierarchicalFlattenedApplyGateCount;
        if (counter is null)
        {
            return;
        }
        ...
        TagList tags = default;
        tags.Add(Tags.CanApply, canApply);
        tags.Add(Tags.Reason, string.IsNullOrWhiteSpace(reason) ? HierarchicalFlattenedApplyGateReasons.Allowed : reason);
        tags.Add(Tags.ChangeCount, Math.Max(0, changeCount));
        counter.Add(1, tags);
    }
