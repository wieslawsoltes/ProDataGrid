...
partial class DataGridFluentTheme : Styles, IResourceNode
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DataGridFluentTheme"/> class.
    /// </summary>
    /// <param name="serviceProvider">Optional service provider used by XAML loader.</param>
    public DataGridFluentTheme(IServiceProvider? serviceProvider = null)
    {
    ...
    /// </summary>
    public static readonly DirectProperty<DataGridFluentTheme, DataGridDensityStyle> DensityStyleProperty =
        AvaloniaProperty.RegisterDirect<DataGridFluentTheme, DataGridDensityStyle>(
            nameof(DensityStyle),
            o => o.DensityStyle,
